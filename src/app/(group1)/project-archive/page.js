    ...
    <section className="relative w-full">
      <div id="projects" className="container-fluid">
        <SectionTitle
          ...
          sectionDesc={
            "De comfortabele kant van op avontuur gaan met ons, is met behoud van je eigen vertrouwde authenticiteit, je openstellen voor de verbeelding van fantasieën, <span class=\"highlight-text\">om samen nieuwe mogelijkheden voor het interieur te ontdekken.</span> Laat je inspireren en informeren door onderstaande diensten die wij bieden en de projecten die wij reeds uit hebben mogen voeren."
          }
        />
      </div>
